...
export class DragAndDropService {
  ...
  public get subscribe$(): Observable<object> {
    return this.exchangeRes$.asObservable();
  }
  ...
  public configure(configure: IConfigure): void {
    ...
    this.dragAndDropTransition = typeof configure.dropDelay !== 'undefined' ? configure.dropDelay : this.dragAndDropTransition;
  }
